...
file_put_contents($debug_log, "=== WEBHOOK VIEW LOADED ===\n" . date('Y-m-d H:i:s') . "\n", FILE_APPEND);

/**
 * Webhook view
 */
class ProduccionViewWebhook
{
    /**
     * Display the view
     *
    ...
    public function display($tpl = null)
    {
        // Debug log
        $debug_log = JPATH_ADMINISTRATOR . '/logs/com_produccion_debug.log';
        file_put_contents($debug_log, "=== WEBHOOK DISPLAY METHOD ===\n" . date('Y-m-d H:i:s') . "\n", FILE_APPEND);
        
        // Include the template
        $template_path = JPATH_ADMINISTRATOR . '/components/com_produccion/views/webhook/tmpl/default.php';
